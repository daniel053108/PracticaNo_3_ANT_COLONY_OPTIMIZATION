...
# Coordenadas aproximadas (X = Longitud, Y = Latitud)
CITY_POSITIONS = {
    "Tijuana": (-117.0, 32.5), "Tecate": (-116.6, 32.5), "Mexicali": (-115.4, 32.6),
    "Rosarito": (-117.0, 32.3), "Ensenada": (-116.6, 31.8), "San Felipe": (-114.8, 31.0),
    "San Quintin": (-115.9, 30.4), "Guerrero Negro": (-114.0, 28.0), "Santa Rosalia": (-112.2, 27.3),
    "Mulege": (-111.9, 26.9), "Ciudad Constitucion": (-111.6, 25.0), "San Carlos": (-112.1, 24.8),
    "La Paz": (-110.3, 24.1), "San Jose del Cabo": (-109.7, 23.0), "Cabo San Lucas": (-109.9, 22.9),
